      ...
      <div className="animate-fade-in">
        ...
        <div style={{ marginLeft: '12px', paddingLeft: '32px', borderLeft: '2px solid rgba(245, 166, 35, 0.3)', display: 'flex', flexDirection: 'column', gap: '48px' }}>
          ...
          <div style={{ position: 'relative', padding: '32px', background: 'rgba(255, 255, 255, 0.03)', backdropFilter: 'blur(24px) saturate(180%)', WebkitBackdropFilter: 'blur(24px) saturate(180%)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '16px' }}>
            ...
            <h2 style={{ fontSize: '24px', color: 'white', marginBottom: '12px', fontFamily: "'Barlow Condensed', sans-serif" }}>{t('guide.trans.step1')}</h2>
          ...
          <div style={{ position: 'relative', padding: '32px', background: 'rgba(255, 255, 255, 0.03)', backdropFilter: 'blur(24px) saturate(180%)', WebkitBackdropFilter: 'blur(24px) saturate(180%)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '16px' }}>
            ...
            <h2 style={{ fontSize: '24px', color: 'white', marginBottom: '12px', fontFamily: "'Barlow Condensed', sans-serif" }}>{t('guide.trans.step2')}</h2>
            <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6', fontSize: '16px', marginBottom: 0 }}>{t('guide.trans.step2_desc')}</p>
          </div>

          <div style={{ position: 'relative', padding: '32px', background: 'rgba(255, 255, 255, 0.03)', backdropFilter: 'blur(24px) saturate(180%)', WebkitBackdropFilter: 'blur(24px) saturate(180%)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '16px' }}>
            <div style={{ position: 'absolute', left: '-45px', top: '32px', width: '26px', height: '26px', borderRadius: '50%', background: 'var(--amber)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', color: '#000', fontSize: '16px', boxShadow: '0 0 16px rgba(245, 166, 35, 0.4)' }}>!</div>
            <h2 style={{ fontSize: '24px', color: 'white', marginBottom: '12px', fontFamily: "'Barlow Condensed', sans-serif" }}>{t('guide.trans.step3')}</h2>
            <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6', fontSize: '16px', marginBottom: 0 }}>{t('guide.trans.step3_desc')}</p>
          </div>
          ...
          <div style={{ position: 'relative', padding: '32px', background: 'rgba(255, 255, 255, 0.03)', backdropFilter: 'blur(24px) saturate(180%)', WebkitBackdropFilter: 'blur(24px) saturate(180%)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '16px' }}>
            ...
            <h2 style={{ fontSize: '24px', color: 'white', marginBottom: '12px', fontFamily: "'Barlow Condensed', sans-serif" }}>{t('guide.trans.step4')}</h2>
