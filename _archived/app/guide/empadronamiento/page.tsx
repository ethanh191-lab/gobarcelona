      ...
      <div className="animate-fade-in">
        ...
        <div style={{ marginLeft: '12px', paddingLeft: '32px', borderLeft: '3px solid var(--ocean)', display: 'flex', flexDirection: 'column', gap: '48px' }}>
          ...
          <div className="glass-panel" style={{ position: 'relative', padding: '32px' }}>
            ...
            <h2 style={{ fontSize: '1.4rem', color: 'var(--heading-color)', marginBottom: '12px', fontFamily: 'Syne, sans-serif' }}>{t('guide.empadronamiento.step1')}</h2>
            <p style={{ color: 'var(--text-primary)', lineHeight: '1.6', marginBottom: 0 }}>{t('guide.empadronamiento.step1_desc')}</p>
          </div>
          ...
          <div className="glass-panel" style={{ position: 'relative', padding: '32px' }}>
            ...
            <h2 style={{ fontSize: '1.4rem', color: 'var(--heading-color)', marginBottom: '12px', fontFamily: 'Syne, sans-serif' }}>{t('guide.empadronamiento.step2')}</h2>
            <p style={{ color: 'var(--text-primary)', lineHeight: '1.6', marginBottom: 0 }}>{t('guide.empadronamiento.step2_desc')}</p>
          </div>
          ...
          <div className="glass-panel" style={{ position: 'relative', padding: '32px' }}>
            ...
            <h2 style={{ fontSize: '1.4rem', color: 'var(--heading-color)', marginBottom: '12px', fontFamily: 'Syne, sans-serif' }}>{t('guide.empadronamiento.step3')}</h2>
            <p style={{ color: 'var(--text-primary)', lineHeight: '1.6', marginBottom: 0 }}>{t('guide.empadronamiento.step3_desc')}</p>
          </div>
